        ...
        child: GestureDetector(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              // ✅ ctrl: controller — plus de const
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(20, 16, 20, 0),
                  child: SearchBarWidget(ctrl: controller),
                ),
              ),
              SliverToBoxAdapter(
                child: Padding(
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(20, 24, 20, 0),
                  child: SuggestionChipsWidget(ctrl: controller),
                ),
              ),
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(20, 24, 20, 0),
                  child: QuickFilterGrid(ctrl: controller),
                ),
              ),
              SliverToBoxAdapter(
                child: Padding(
  ...
  Widget _buildHeroTitle() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text('Qu\'est-ce qu\'on\nmange à Dakar ?', style: AppTextStyles.heroTitle),
      ],
    );
  }
