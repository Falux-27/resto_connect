...
//                 size: 18,
//                 color: controller.isFavorite.value ? Colors.redAccent : AppColors.ink,
//               ),
//             ),
//           )),
//         ),
...
//             child: const Center(child: Icon(Icons.restaurant_rounded, color: AppColors.muted, size: 60)),
//           ),
//         ),
//       ),
//     );
...
//           Row(
//             children: [
//               Text(_cuisineLabel(r), style: AppTextStyles.bodySmall.copyWith(fontWeight: FontWeight.w500)),
//               Padding(
...
//                     crossAxisAlignment: CrossAxisAlignment.start,
//                     children: [
//                       Text('Pourquoi Resto recommande', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.w700)),
//                       if (r.matchScore != null)
//                         Text('SCORE ${r.matchScore} / 100', style: AppTextStyles.labelCaps.copyWith(color: AppColors.teal)),
//                     ],
//                   ),
//                 ),
//               ],
//             ),
//             const SizedBox(height: 12),
//             if (r.whyRecommended.isNotEmpty) WhyRecommendedRow(reasons: r.whyRecommended),
...
//               Text('${r.menu.length} plat${r.menu.length > 1 ? "s" : ""}', style: AppTextStyles.bodySmall),
//             ],
//           ),
//           const SizedBox(height: 12),
//           ...r.menu.map((item) => Padding(
//             padding: const EdgeInsets.symmetric(vertical: 11),
//             child: Row(
//               children: [
//                 Expanded(child: Text(item.name, style: AppTextStyles.bodyMedium.copyWith(color: AppColors.ink))),
//                 const SizedBox(width: 16),
//                 Text('${_fmt(item.price)} FCFA', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.w700)),
//               ],
//             ),
//           )),
//         ],
...
//             sub: r.distanceKm != null ? '${r.distanceLabel} · ${(r.distanceKm! * 12).round()} min à pied' : null,
//           ),
...
//             child: Container(
//               height: 160,
//               decoration: BoxDecoration(color: const Color(0xFFE8EEEC), borderRadius: BorderRadius.circular(16)),
//               child: Stack(
//                 children: [
//                   CustomPaint(size: const Size(double.infinity, 160), painter: _FakeMapPainter()),
//                   Center(
//                     child: Column(
...
//                           Text(
//                             r.distanceKm != null ? r.distanceLabel : r.zone,
...
//             ElevatedButton(onPressed: controller.goBack, child: const Text('Retour')),
//           ],
//         ),
//       ),
//     );
...
//     return r.tags
//         .where((t) => ['senegalais', 'africain', 'fusion', 'fruits de mer', 'grillades'].contains(t))
...
//                   Text(sub!, style: AppTextStyles.bodySmall.copyWith(color: subColor ?? AppColors.muted, fontWeight: FontWeight.w500)),
//                 ],
//               ],
//             ),
//           ),
...
//   @override
//   Widget build(BuildContext context) {
//     return Container(height: 1, color: AppColors.divider, margin: const EdgeInsets.symmetric(horizontal: 20));
//   }
// }
...
//     final paint = Paint()..color = const Color(0xFFD4DDD9)..strokeWidth = 8..style = PaintingStyle.stroke..strokeCap = StrokeCap.round;
//     final p1 = Path()
//       ..moveTo(0, size.height * 0.45)
//       ..quadraticBezierTo(size.width * 0.35, size.height * 0.3, size.width * 0.65, size.height * 0.55)
//       ..quadraticBezierTo(size.width * 0.85, size.height * 0.7, size.width, size.height * 0.6);
//     final p2 = Path()
//       ..moveTo(0, size.height * 0.7)
//       ..quadraticBezierTo(size.width * 0.25, size.height * 0.85, size.width * 0.5, size.height * 0.75)
//       ..quadraticBezierTo(size.width * 0.75, size.height * 0.65, size.width, size.height * 0.8);
